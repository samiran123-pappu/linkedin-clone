...
export const createLoginAlertEmailTemplate = (name) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(to right, #0077B5, #00A0DC); padding: 24px; text-align: center; border-radius: 10px 10px 0 0;">
    <h1 style="color: white; margin: 0; font-size: 22px;">New Login Detected</h1>
  </div>
  <div style="background-color: #ffffff; padding: 24px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.08);">
    <p style="font-size: 16px; color: #0077B5;"><strong>Hello ${name || "there"},</strong></p>
    <p>We noticed a login to your UnLinked account. If this was you, you can ignore this message.</p>
    <p>If this wasn’t you, please change your password.</p>
    <p style="margin-top: 24px;">Best regards,<br/>The UnLinked Team</p>
  </div>
</body>
</html>
`;